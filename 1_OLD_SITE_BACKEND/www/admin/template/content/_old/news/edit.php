									...
									<form action="index.php?item=<?php echo $item; ?>" method="POST">
                                        <fieldset class="form-horizontal">
                                            <div class="form-group"><label class="col-sm-2 control-label">Дата:</label>
                                                <div class="col-sm-10"><input type="text" name="date" class="form-control" value="<?php echo $data['date'];?>"></div>
                                            </div>
                                            ...
                                            <label>Текст</label>
                                            <textarea class="summernote" name="long_text"><?php echo $data['long_text'];?></textarea>

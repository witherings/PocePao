                    ...
                    <div class="tabs-container">
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    ...
                                    <?php
									$result = mysql_query("SELECT * FROM coaches WHERE id='$id'", $db);
									...
									<form action="index.php?item=<?php echo $item; ?>" method="POST">
                                        <fieldset class="form-horizontal">
                                            ...
                                            <br>   
                                        <img src="../upload/coaches/<?php echo $data['img']; ?>">
                                        <br><br>  
                                        </fieldset>
                                        ...
                                        <a href="index.php?item=<?php echo $item; ?>" class="btn btn-default btn-lg">Отмена</a>
                                         ...
                                         <div class="ibox-content" style="border:none; padding:15px 0px;">
                                            <form action="template/actions/upload.php?type=coaches&id=<?php echo $id;?>" id="my-awesome-dropzone" class="dropzone">

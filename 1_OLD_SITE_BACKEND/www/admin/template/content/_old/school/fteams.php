                                ...
                                <div id="tab-1" class="tab-pane active">
									...
									<form action="index.php?item=<?php echo $item; ?>" method="POST">
                                        <fieldset class="form-horizontal">
                                            ...
                                            <br>   
                                        <img src="../upload/school/school_logos.png" height="200">
                                        <br><br>  
                                        </fieldset>
                                        ...
                                        <a href="index.php?item=<?php echo $item; ?>" class="btn btn-default btn-lg">Отмена</a>
                                         ...
                                         <div class="ibox-content" style="border:none; padding:15px 0px;">
                                            <form action="template/actions/upload.php?type=fteams" id="my-awesome-dropzone" class="dropzone">
                                                <div class="dropzone-previews"></div>
                                                <a class="btn btn-primary pull-left">400 x 190 PNG</a>
                                            </form>
                                         </div>

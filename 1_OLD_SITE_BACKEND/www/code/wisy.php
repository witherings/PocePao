...
<script type="text/javascript">
	tinyMCE.init({
		...
		theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,image,code,|,forecolor,backcolor,cut,copy,paste,pastetext,pasteword",
		theme_advanced_buttons3 : "hr,removeformat,|,sub,sup,|,charmap,|,insertdate,inserttime,|,insertfile,insertimage|,tablecontrols,iespell,media",

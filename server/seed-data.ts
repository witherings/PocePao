...
async function seedDatabase() {
  try {
    ...
    await db.insert(ingredients).values([
      // Proteins
      { name: "Salmon", nameDE: "Lachs", type: "protein", image: "/images/ing-salmon.jpg", price: "4.00", order: 1 },
      { name: "Tuna", nameDE: "Thunfisch", type: "protein", image: "/images/ing-tuna.jpg", price: "4.50", order: 2 },
      { name: "Shrimp", nameDE: "Garnelen", type: "protein", image: "/images/ing-shrimp.jpg", price: "5.00", order: 3 },
      { name: "Tofu", nameDE: "Tofu", type: "protein", image: "/images/ing-tofu.jpg", price: "3.00", order: 4 },
      
      // Bases
      { name: "Sushi Rice", nameDE: "Sushi Reis", type: "base", image: "/images/ing-sushi-rice.jpg", order: 1 },
      { name: "Brown Rice", nameDE: "Brauner Reis", type: "base", image: "/images/ing-brown-rice.jpg", order: 2 },
      { name: "Quinoa", nameDE: "Quinoa", type: "base", image: "/images/ing-quinoa.jpg", order: 3 },
      { name: "Mixed Greens", nameDE: "Gemischter Salat", type: "base", image: "/images/ing-greens.jpg", order: 4 },
      
      // Marinades
      { name: "Classic Soy", nameDE: "Klassische Soja", type: "marinade", image: "/images/ing-soy.jpg", order: 1 },
      { name: "Spicy Mayo", nameDE: "Scharfe Mayo", type: "marinade", image: "/images/ing-spicy-mayo.jpg", order: 2 },
      { name: "Sesame Oil", nameDE: "Sesamöl", type: "marinade", image: "/images/ing-sesame.jpg", order: 3 },
      
      // Fresh Ingredients
      { name: "Edamame", nameDE: "Edamame", type: "fresh", image: "/images/ing-edamame.jpg", order: 1 },
      { name: "Cucumber", nameDE: "Gurke", type: "fresh", image: "/images/ing-cucumber.jpg", order: 2 },
      { name: "Avocado", nameDE: "Avocado", type: "fresh", image: "/images/ing-avocado.jpg", order: 3 },
      { name: "Mango", nameDE: "Mango", type: "fresh", image: "/images/ing-mango.jpg", order: 4 },
      { name: "Seaweed", nameDE: "Seetang", type: "fresh", image: "/images/ing-seaweed.jpg", order: 5 },
      { name: "Cherry Tomatoes", nameDE: "Kirschtomaten", type: "fresh", image: "/images/ing-tomatoes.jpg", order: 6 },
      
      // Sauces
      { name: "Soy Sauce", nameDE: "Sojasauce", type: "sauce", image: "/images/ing-soy-sauce.jpg", order: 1 },
      { name: "Ponzu", nameDE: "Ponzu", type: "sauce", image: "/images/ing-ponzu.jpg", order: 2 },
      { name: "Tahini", nameDE: "Tahini", type: "sauce", image: "/images/ing-tahini.jpg", order: 3 },
      
      // Toppings
      { name: "Sesame Seeds", nameDE: "Sesamsamen", type: "topping", image: "/images/ing-sesame-seeds.jpg", order: 1 },
      { name: "Green Onion", nameDE: "Frühlingszwiebel", type: "topping", image: "/images/ing-green-onion.jpg", order: 2 },
      { name: "Crispy Onions", nameDE: "Knusprige Zwiebeln", type: "topping", image: "/images/ing-crispy-onion.jpg", order: 3 },
      { name: "Nori Strips", nameDE: "Nori Streifen", type: "topping", image: "/images/ing-nori.jpg", order: 4 },
    ]);
